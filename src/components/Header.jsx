...
const Header = () => {
  return (
    <header className="h-[48px] bg-header text-headerText flex items-center justify-between px-[24px] max-w-screen">
      {/* Left part */}
      <div className="flex items-center">
        ...
        {/* Line vertical */}
        <div className="border-r-[1px] h-[16px] ml-[20px] mr-[10px] border-gray/30"></div>
      ...
      <div className="flex items-center">
        ...
        <div className="border-r-[1px] h-[16px] mx-[20px] border-gray/30"></div>
